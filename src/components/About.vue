<template>
    <div>
        ...
        <h1> 
            ...
            of color. This is not to deny the fact that white people can be 
            marginalized in other ways, but to acknowledge that the publishing 
            industry often spends the majority of its resources publishing and 
